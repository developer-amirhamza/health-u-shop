...
const Footer = () => {
    return (
        <footer className='w-full h-max flex flex-col items-center justify-center bg-primary pt-16 gap-10  '>
            <div className="container w-full flex flex-col md:flex-row items-start justify-center   gap-y-10  ">
                ...
                <ul className="flex flex-wrap w-full items-start justify-between px-8 max-w-3/5 gap-5 text-text">
                ...
                <ul className='flex flex-col gap-10 items-start justify-start text-text ' >
            ...
            <div className="container my-20">
                <div className="flex flex-col md:flex-row gap-10 ">
                    ...
                    <p className="text-text text-sm">
                        ...
                        Cutimed, JOBS, Knix, Leukoplast, Libero, Libresse, Lotus, Modibodi, Nosotras, Saba, Tempo, TOM Organic and Zewa. In 2023,
            ...
            <div className="flex w-full flex-col items-center py-10 px-0 mx-0 gap-8 justify-center">
                <div className='w-full h-0.5 bg-text' />
                <p className="text-text text-lg font-medium">Copyright &copy; {new Date().getFullYear()} AIDBLE CARE
